...
> | /Post/Comment\[author_name=john\]/../name | john によって書かれた Comment を少なくとも 一つ持つ全ての Post の名前を選びます。 |
...
> | /Comment/@\* | 全てのコメントのキー名を選びます。 現在のところ、単一の「/」を使った 絶対パスのみサポートされています。 バグを発見したら、それを報告してください。 また機能追加の提案も歓迎します。 |
>
